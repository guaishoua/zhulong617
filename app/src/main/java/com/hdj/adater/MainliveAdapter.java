...
public class MainliveAdapter extends RecyclerView.Adapter<MainliveAdapter.ViewHolder> {
    ...
    private List<HomeBannerBean.ResultBean.LiveBean> data = new ArrayList<>();

    public MainliveAdapter(Context pContext) {
        mContext = pContext;
    }

    public void setData(List<HomeBannerBean.ResultBean.LiveBean> pData) {
        data.addAll(pData);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        HomeBannerBean.ResultBean.LiveBean liveBean = data.get(position);
